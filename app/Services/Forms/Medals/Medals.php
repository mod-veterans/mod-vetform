...
namespace App\Services\Forms\Medals;


use App\Services\Forms\BaseForm;
use App\Services\Forms\Medals\Groups\AboutYou;
use App\Services\Forms\Medals\Groups\Service;
use App\Services\Forms\Medals\Groups\Submission;

class Medals extends BaseForm
{
     ...
     * @var string
     */
    protected string $name = 'Apply for well-earned medal';
