...
<x-layout :view="null" :questions="null">
    <x-slot name="title">{{ 'Cookie statement' }}</x-slot>
    <x-slot name="body">
    <p class="govuk-body">Cookies are files saved on your computer, tablet or telephone when you visit a website.
        Apply for an Armed Forces Compensation or War Pension Payment :</p>
    ...
    <ul class="govuk-list govuk-list--number">
        <li>
            ...
            <ul class="govuk-list govuk-list--bullet">
                ...
                <li>the pages you visit on search for {{ env('APP_NAME', 'Apply for an Armed Forces Compensation or War Pension Payment') }}
            ...
            <form id="cookie-usage-preference-form" method="post" action="{{ route('cookie-policy.save') }}" novalidate>
                ...
                <x-radio-group :options="[
                    ...
                    'validation' => 'required',
                    'options' => [
                        ['value' => \App\Services\Constant::YES, 'label' => 'Use cookies that measure my website use', 'children' => []],
                        ['value' => \App\Services\Constant::NO , 'label' => 'Do not use cookies that measure my website use', 'children' => []]
                    ]
                ]"></x-radio-group>
