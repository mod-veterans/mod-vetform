...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['witnesses'])) {
        $witnesses['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['witnesses'];
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/claim-accident-witness/sporting-witnesses'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['witnesses'] = $_POST['/claim-details/claim-accident-witness/sporting-witnesses'];
    ...
    if ($errors == 'Y') {
        ...
        $theURL = '/applicant/claims/specific/first-aid';
