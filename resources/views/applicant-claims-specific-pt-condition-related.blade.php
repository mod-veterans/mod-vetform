...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['why'])) {
        $condition['data'] = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['why'];
    }
} else {
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/claim-illness-note/claim-illness-note'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['why'] = cleanTextData($_POST['/claim-details/claim-illness-note/claim-illness-note']);
    ...
    if ($errors == 'Y') {
        ...
        $theURL = '/applicant/claims/specific/pt/check-answers';
