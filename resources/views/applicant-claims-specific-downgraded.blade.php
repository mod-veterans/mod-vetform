...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'])) {
        $downgraded['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'];
...
if ( (!empty($_POST['/claim-details/claim-downgraded/claim-illness-downgraded'])) && (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'])) &&
($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'] == $_POST['/claim-details/claim-downgraded/claim-illness-downgraded']) ) {
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/claim-downgraded/claim-illness-downgraded'])) {
        ...
        switch ($_POST['/claim-details/claim-downgraded/claim-illness-downgraded']) {
            ...
            case "Yes":
                $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'] = 'Yes';
                $downgradedchk['Yes'] = ' checked';
                $theURL = '/applicant/claims/specific/downgraded/when';

            break;

            case "No":
                $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded'] = 'No';
