...
if (empty($_POST['afcs/about-you/personal-details/contact-number/mobilepermission'])) {
                ...
                $errors = 'Y';
                $errorsList[] = '<a href="#afcs/about-you/personal-details/contact-number/mobile-permission">Please tell us if you want us to send you text messages about your claim</a>';
                ...
                '<span id="afcs/about-you/personal-details/contact-number/mobile-permission-error" class="govuk-error-message">
                    <span class="govuk-visually-hidden">Error:</span> Please tell us if you want us to send you text messages about your claim
                 </span>';
