    ...
    <main class="govuk-main-wrapper govuk-main-wrapper--auto-spacing" id="main-content" role="main">
        <div class="govuk-grid-row">
            <div class="govuk-grid-column-two-thirds">
                                <h1 class="govuk-heading-xl">Making a claim on behalf of someone else</h1>
...
<p class="govuk-body">Please upload confirmation of the authority you have, for example the letter giving you Power of Attorney, within ‘Supporting Documents’ when you reach that section. You can send us a copy in the post if you prefer.  Details of how to do this can also be found under ‘Supporting Documents’.  </p>
