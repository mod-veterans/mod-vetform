...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'])) {
        $hospital['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'];
...
if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'])) {
   ...
   if ( (!empty($_POST['/claim-details/claim-accident-hospital-facility/sporting-hospital-facility'])) &&
    ($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'] == $_POST['/claim-details/claim-accident-hospital-facility/sporting-hospital-facility']) ) {
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/claim-accident-hospital-facility/sporting-hospital-facility'])) {
        ...
        switch ($_POST['/claim-details/claim-accident-hospital-facility/sporting-hospital-facility']) {
            ...
            case "Yes":
               $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'] = 'Yes';
               $hospitalchk['Yes'] = ' checked';
               $theURL = '/applicant/claims/specific/pt/hospital/address';

            break;

            case "No":
                $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['hospital'] = 'No';
