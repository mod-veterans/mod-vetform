...
if (!empty($_POST)) {
    ...
    if (empty($_POST['afcs/about-you/personal-details/served-special-forces'])) {
            ...
            if (!empty($_POST['afcs/about-you/personal-details/epaw-reference-1'])) {
                ...
                $errors = 'Y';
                $errorsList[] = '<a href="#afcs/about-you/personal-details/served-special-forces-no">Tell us your EPAW reference in number/date format</a>';
...
@endphp
  ...
  <div class="govuk-body" id="afcs/about-you/personal-details/epaw-reference">
    ...
    <div class="govuk-radios" data-module="govuk-radios">
      ...
      <div class="govuk-radios__conditional {{$numHidden ?? ''}}" id="conditional-contact">
        <div class="govuk-form-group">
          <label class="govuk-label" for="contact-by-email" id="afcs/about-you/personal-details/epaw-reference">
            EPAW reference
          </label>
