...
You can leave blank any sections you can’t remember.
    ...
    <input name="/other-medical-treatment-address/completed" type="hidden" value="1">
</div>
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/hospital-name">
        ...
        id="/other-medical-treatment-address/hospital-name" name="/other-medical-treatment-address/hospital-name" type="text"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/address-line-1">
        ...
        id="/other-medical-treatment-address/address-line-1" name="/other-medical-treatment-address/address-line-1" type="text"
         autocomplete="address-line1"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/address-line-2">
        ...
        id="/other-medical-treatment-address/address-line-2" name="/other-medical-treatment-address/address-line-2" type="text"
         autocomplete="address-line2"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/town">
        Town or city
    </label>
            <input
        class="govuk-input govuk-!-width-two-thirds "
    ...
    <label class="govuk-label" for="/other-medical-treatment-address/county">
        ...
        id="/other-medical-treatment-address/county" name="/other-medical-treatment-address/county" type="text"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/country">
        Country
    </label>
...
@endphp
                    ...
                    <option value="Åland Islands"
                     >Åland Islands</option>
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/postcode">
        Postcode
    </label>
            <input
        class="govuk-input govuk-!-width-two-thirds "
        id="/other-medical-treatment-address/postcode" name="/other-medical-treatment-address/postcode" type="text"
         autocomplete="postal-code"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/hospital-contact-number">
        Telephone number
    </label>
            <input
        class="govuk-input govuk-!-width-two-thirds "
         ...
         autocomplete="tel"
           inputmode="numeric" pattern="[0-9]*"
            ...
            >
                                    ...
                                    <div class="govuk-form-group ">
    <label class="govuk-label" for="/other-medical-treatment-address/hospital-email">
        Email
    </label>
            <input
        class="govuk-input govuk-!-width-two-thirds "
