    ...
    <main class="govuk-main-wrapper govuk-main-wrapper--auto-spacing" id="main-content" role="main">
        <div class="govuk-grid-row">
            <div class="govuk-grid-column-two-thirds">
                               ...
                               <p class="govuk-body">If you have had more than one period of service,[insert space] or changed service branch for example from Royal Navy to Army, please tell us about each period separately.</p>
