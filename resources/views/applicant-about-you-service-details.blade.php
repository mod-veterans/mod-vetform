    ...
    <main class="govuk-main-wrapper govuk-main-wrapper--auto-spacing" id="main-content" role="main">
        <div class="govuk-grid-row">
            <div class="govuk-grid-column-two-thirds">
                                ...
                                <p class="govuk-body">
                                                                        We need to know about each period of service you have had in HM Armed Forces. A period of
                         service is defined as a term of service between enlistment and discharge within one service type.
                                                                </p>
                                                                                                                                    <p class="govuk-body">
                                                                        If you have had more than one period of service,or changed branches services for example from
