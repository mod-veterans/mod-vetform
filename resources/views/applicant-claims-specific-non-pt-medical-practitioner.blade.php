...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address'])) {

        $name['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['name'];
        $address1['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['address1'];
        $address2['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['address2'];
        $town['data']                = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['town'];
        $county['data']              = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['county'];
        $country['data']             = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['country'];
        $postcode['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['postcode'];
        $telephone['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['telephone'];
        $email['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['email'];
...
if (!empty($_POST)) {
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-practitioner'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['name'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-practitioner']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__address-line-1'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['address1'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__address-line-1']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__address-line-2'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['address2'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__address-line-2']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__town'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['town'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__town']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__county'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['county'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__county']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__country'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['country'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__country']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__postcode'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['postcode'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-address__postcode']);
    }

    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-number'])) {

    } else {
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['telephone'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-number']);
    }
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-email'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['hospital-address']['email'] = cleanTextData($_POST['/claim-details/claim-accident-sporting-surgery-address/claim-accident-sporting-surgery-email']);
    }
    ...
    if ($errors == 'Y') {
        ...
        $theURL = '/applicant/claims/specific/non-pt/date';
    ...
    <main class="govuk-main-wrapper govuk-main-wrapper--auto-spacing" id="main-content" role="main">
        <div class="govuk-grid-row">
            <div class="govuk-grid-column-two-thirds">
                                ...
                                <p class="govuk-body">If you need to tell us about more than one medical practitioner or hospital, you can do this in ‘Other Medical Treatment’ later.</p>
