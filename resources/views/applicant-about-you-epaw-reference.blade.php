...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['about-you']['epaw']['served'])) {
        $served['data']           = @$data['sections']['about-you']['epaw']['served'];
        $epawref['data']        = @$data['sections']['about-you']['epaw']['epaw-reference'];
...
if (!empty($_POST)) {
    ...
    if (empty($_POST['afcs/about-you/personal-details/served-special-forces'])) {
            ...
            if (!empty($_POST['afcs/about-you/personal-details/epaw-reference'])) {
                ...
                $data['sections']['about-you']['epaw']['epaw-reference'] = $_POST['afcs/about-you/personal-details/epaw-reference'];
                $data['sections']['about-you']['epaw']['served'] = 'Yes';
                ...
                $errors = 'Y';
                $errorsList[] = '<a href="#afcs/about-you/personal-details/contact-number/mobile-number">Give us your EPAW number</a>';
                ...
                '<span id="afcs/about-you/personal-details/contact-number/mobile-number-error" class="govuk-error-message">
                    <span class="govuk-visually-hidden">Error:</span> Give us your EPAW number
                 </span>';
                 $numHidden = '';
                ...
                $data['sections']['about-you']['epaw']['served'] = 'No';
