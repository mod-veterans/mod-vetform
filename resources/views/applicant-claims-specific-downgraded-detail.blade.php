...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories'])) {
        $frommedical['data'] = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['frommedical'];
        $tomedical['data'] = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['tomedical'];
        $multiple['data'] = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['multiple'];
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/specific/downgraded/from-medical'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['frommedical'] = cleanTextData($_POST['/claim-details/specific/downgraded/from-medical']);
    ...
    if (!empty($_POST['/claim-details/specific/downgraded/to-medical'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['tomedical'] = cleanTextData($_POST['/claim-details/specific/downgraded/to-medical']);
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/date-of-condition-estimated'])) && ($_POST['/claim-details/claim-illness-date/date-of-condition-estimated'] == 'Yes') ) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['medical-categories']['multiple'] = 'Yes';
        $multiplechk = ' checked';
    } else {
