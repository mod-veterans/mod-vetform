...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'])) {
        $downgraded['data']            = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'];
...
if ( (!empty($_POST['/claim-details/claim-downgraded/claim-illness-downgraded'])) && (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'])) &&
($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'] == $_POST['/claim-details/claim-downgraded/claim-illness-downgraded']) ) {
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['/claim-details/claim-downgraded/claim-illness-downgraded'])) {
        ...
        switch ($_POST['/claim-details/claim-downgraded/claim-illness-downgraded']) {
            ...
            case "Yes":
                $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'] = 'Yes';
                $downgradedchk['Yes'] = ' checked';
                $theURL = '/applicant/claims/specific/pt/downgraded/when';

            break;

            case "No":
                $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'] = 'No';
                $downgradedchk['No'] = ' checked';
                $theURL = '/applicant/claims/specific/pt/why-related';
            break;

            case "Dont Know":
                $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['downgraded'] = 'Dont Know';
        ...
        $errors = 'Y';
        $errorsList[] = '<a href="#/claim-details/claim-downgraded/claim-illness-downgraded-yes">Tell us if you were downgraded</a>';
