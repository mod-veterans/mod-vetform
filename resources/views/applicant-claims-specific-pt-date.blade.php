...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date'])) {
        $conditionday['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date']['day'];
        $conditionmonth['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date']['month'];
        $conditionyear['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date']['year'];
        $conditionapproximate['data']   = @$data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date']['approximate'];
...
if (!empty($_POST)) {
    ...
    if (empty($_POST['/claim-details/claim-accident-sporting-date/date-of-injury-incident-year'])) {
        $errors = 'Y';
        $errorsList[] = '<a href="/claim-details/claim-accident-sporting-date/date-of-injury-incident-year">Please give us at least an approximate year</a>';
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/date-of-condition-estimated'])) && ($_POST['/claim-details/claim-illness-date/date-of-condition-estimated'] == 'Yes')) {
        $data['sections']['claims']['records'][$thisRecord]['specific']['pt']['condition-start-date']['approximate'] = cleanTextData($_POST['/claim-details/claim-illness-date/date-of-condition-estimated']);
        $approximatechk = ' checked';
     } else {
    ...
    if ($errors == 'Y') {
        ...
        $theURL = '/applicant/claims/specific/pt/activity';
