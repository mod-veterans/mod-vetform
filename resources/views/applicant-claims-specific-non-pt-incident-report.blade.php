...
if (!empty($_POST)) {
    ...
    if (empty( $_POST['/claim-details/claim-accident-non-sporting-report-to/claim-accident-non-sporting-report-to'])) {
            ...
            $errors = 'Y';
            $errorsList[] = '<a href="#/claim-details/claim-accident-non-sporting-report-to/claim-accident-non-sporting-report-to">Please tell us who you reported the incident to.</a>';
            ...
            '<span id="/claim-details/claim-accident-non-sporting-report-to/claim-accident-non-sporting-report-to-error" class="govuk-error-message">
                <span class="govuk-visually-hidden">Error:</span>Please tell us who you reported the incident to.
             </span>';
