...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end'])) {
        $datetoday['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['today'];
        $datetomonth['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['tomonth'];
        $datetoyear['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['toyear'];
        $stilldowngraded['data']   = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['stilldowngraded'];
        $datesapproximate['data']   = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['datesapproximate'];
  ...
  if ( (empty($_POST['/claim-details/claim-illness-date/still-downgraded']))  ) {
        ...
        if ( (!empty($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'])) && ($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'] == 'Yes') ) {
                ...
                if ( (empty($datetoday['data'])) || (empty($datetomonth['data'])) || (empty($datetoyear['data'])) ) {
                   ...
                   $errors = 'Y';
                    $errorsList[] = '<a href="#/claim-details/claim-downgraded-dates/date-to-year">Enter a valid date. If you do not know the date, tick \'this date is approximate\' and enter a year</a>';
                    $datetoyear['error'] = 'govuk-form-group--error';
                    $datetoyear['errorLabel'] =
                    '<span id="afcs/about-you/service-details/service-rank/service-rank-error" class="govuk-error-message">
                 ...
                 $errors = 'Y';
                    $errorsList[] = '<a href="#/claim-details/claim-downgraded-dates/date-to-day">The date entered cannot be in the future</a>';
                    $datetoyear['error'] = 'govuk-form-group--error';
                    $datetoyear['errorLabel'] =
                    '<span id="afcs/about-you/service-details/service-rank/service-rank-error" class="govuk-error-message">
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'])) && ($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'] == 'Yes')) {
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['datesapproximate'] = cleanTextData($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated']);
        $datesapproximatechk = ' checked';
     } else {
    ...
    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['toyear'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-year']);
    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['tomonth'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-month']);
    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['today'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-day']);
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/still-downgraded'])) && ($_POST['/claim-details/claim-illness-date/still-downgraded'] == 'Yes')) {
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['stilldowngraded'] = cleanTextData($_POST['/claim-details/claim-illness-date/still-downgraded']);
        $stilldowngradedchk = ' checked';
     } else {

         $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-end']['stilldowngraded'] = 'No';
