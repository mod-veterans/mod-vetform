...
@php echo $datetoyear['errorLabel']; @endphp
    ...
    <br />
                                        <div class="govuk-checkboxes__item">
        <input class="govuk-checkboxes__input" id="6166806a32c4n" name="/claim-details/claim-illness-date/still-downgraded" type="checkbox"
           value="Yes"    {{$stilldowngradedchk ?? ''}}        >
    <label class="govuk-label govuk-checkboxes__label" for="6166806a32c4n">I am still downgraded / was still downgraded at discharge</label>
</div>
