...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when'])) {
        $datefromday['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromday'];
        $datefrommonth['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['frommonth'];
        $datefromyear['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromyear'];
        $datetoday['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromday'];
        $datetomonth['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['frommonth'];
        $datetoyear['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromyear'];
        $stilldowngraded['data']   = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['stilldowngraded'];
        $datesapproximate['data']   = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['datesapproximate'];
...
if (!empty($_POST)) {
    ...
    if (empty($_POST['/claim-details/claim-downgraded-dates/date-from-year'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromyear'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-from-year']);

    }

    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['frommonth'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-from-month']);
    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['fromday'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-from-day']);
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'])) && ($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated'] == 'Yes')) {
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['datesapproximate'] = cleanTextData($_POST['/claim-details/claim-illness-date/date-of-datefrom-estimated']);
        $datesapproximatechk = ' checked';
     } else {
    ...
    if (empty($_POST['/claim-details/claim-downgraded-dates/date-to-year'])) {
        ...
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['toyear'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-year']);

    }

    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['tomonth'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-month']);
    $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['today'] = cleanTextData($_POST['/claim-details/claim-downgraded-dates/date-to-day']);
    ...
    if ( (!empty($_POST['/claim-details/claim-illness-date/still-downgraded'])) && ($_POST['/claim-details/claim-illness-date/still-downgraded'] == 'Yes')) {
        $data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['stilldowngraded'] = cleanTextData($_POST['/claim-details/claim-illness-date/still-downgraded']);
        $stilldowngradedchk = ' checked';
     } else {
    ...
    if ($errors == 'Y') {
        ...
        $theURL = '/applicant/claims/specific/downgraded/detail';
