...
if (empty($_POST)) {
    ...
    if (!empty($data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when'])) {
        ...
        $datetoday['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['today'];
        $datetomonth['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['tomonth'];
        $datetoyear['data']           = @$data['sections']['claims']['records'][$thisRecord]['specific']['non-pt']['downgraded-when']['toyear'];
